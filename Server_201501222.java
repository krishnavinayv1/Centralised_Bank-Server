...
public class Server_201501222 implements Interface_201501222 { 
    public  static Account_201501222 a[]={
        new Account_201501222("vinay",9491334650L,"Premium",1000)   
            ,new Account_201501222("Sridhar",9491334651L,"Premium",400)  
            ,new Account_201501222("Sairagh",9491334652L,"Premium",450)
            ,new Account_201501222("Sr",9491334653L,"Basic",500) 
            ,new Account_201501222("vi",9491334654L,"Basic",600)
    };  
    public Server_201501222() {} 
    public static void main(String args[]) { 
        try { 
            // Instantiating the implementation class 
            Server_201501222 obj = new Server_201501222(); 

            // Exporting the object of implementation class  
            // (here we are exporting the remote object to the stub) 
            Interface_201501222 stub = (Interface_201501222) UnicastRemoteObject.exportObject(obj, 0);  
...
class Account_201501222{ 
    Account_201501222(){};
    Account_201501222(String na,long acc,String type,float amou)
    {
        acc_no=acc;
        name=na;
        amount=amou;
